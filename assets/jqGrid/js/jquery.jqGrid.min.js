...
(function (b) {
    b.jgrid = b.jgrid || {};
    b.extend(b.jgrid, {version: "4.5.0", htmlDecode: function (b) {
        ...
        var a = /^\/Date\((([-+])?[0-9]+)(([-+])([0-9]{2})([0-9]{2}))?\)\/$/, j = "string" === typeof g ?
            ...
            return a
        }, f = {m: 1, d: 1, y: 1970, h: 0, i: 0, s: 0, u: 0}, h = 0, i, k, h = function (a, b) {
        ...
        if (g && null != g)if (!isNaN(g - 0) && "u" === ("" + d).toLowerCase())h = new Date(1E3 * parseFloat(g)); else if (g.constructor === Date)h = g; else if (null !== j)h = new Date(parseInt(j[1], 10)), j[3] &&
            ...
            i = 0;
            for (k = d.length; i < k; i++)"M" === d[i] && (j = b.inArray(g[i], e.monthNames), -1 !== j && 12 > j && (g[i] = j + 1, f.m = g[i])), "F" === d[i] && (j = b.inArray(g[i], e.monthNames), -1 !== j && 11 < j && (g[i] = j + 1 - 12, f.m = g[i])), "a" === d[i] && (j = b.inArray(g[i], e.AmPm), -1 !== j && 2 > j && g[i] === e.AmPm[j] && (g[i] =
                j, f.h = h(g[i], f.h))), "A" === d[i] && (j = b.inArray(g[i], e.AmPm), -1 !== j && 1 < j && g[i] === e.AmPm[j] && (g[i] = j - 2, f.h = h(g[i], f.h))), "g" === d[i] && (f.h = parseInt(g[i], 10)), void 0 !== g[i] && (f[d[i].toLowerCase()] = parseInt(g[i], 10));
            f.f && (f.m = f.f);
        ...
        e.masks.hasOwnProperty(c) ? c = e.masks[c] : c ||
            (c = "Y-m-d");
        d = h.getHours();
        g = h.getMinutes();
        f = h.getDate();
        ...
        k = h.getSeconds();
        var m = h.getMilliseconds(), n = h.getDay(), p = h.getFullYear(), l = (n + 6) % 7 + 1, o = (new Date(p, j - 1, f) - new Date(p, 0, 1)) / 864E5, B = {d: a(f), D: e.dayNames[n], j: f, l: e.dayNames[n + 7], N: l, S: e.S(f), w: n, z: o, W: 5 > l ? Math.floor((o + l - 1) / 7) + 1 : Math.floor((o + l - 1) / 7) || (4 > ((new Date(p - 1, 0, 1)).getDay() + 6) % 7 ? 53 : 52), F: e.monthNames[j - 1 + 12], m: a(j), M: e.monthNames[j - 1], n: j, t: "?", L: "?", o: "?", Y: p, y: ("" + p).substring(2), a: 12 > d ?
        ...
        c = b[g];
        if (void 0 === c)try {
            if ("string" === typeof g && (a = g.split(".")), j = a.length)for (c = b; c && j--;)e = a.shift(), c = c[e]
        } catch (f) {
        }
        return c
        ...
        var d = b("<div class='ui-jqgrid' style='left:10000px'><table class='ui-jqgrid-btable' style='width:5px;'><tr class='jqgrow'><td style='width:5px;'></td></tr></table></div>"), g = d.appendTo("body").find("td").width();
        d.remove();
        return 5 !== g
        ...
        return new function (d, c) {
            ...
            var e =
                this, a = d, j = !0, f = !1, h = c, i = /[\$,%]/g, k = null, m = null, n = 0, p = !1, l = "", o = [], B = !0;
            if ("object" === typeof d && d.push)0 < d.length && (B = "object" !== typeof d[0] ? !1 : !0); else throw"data provides is not an array";
            ...
            this._performSort = function () {
                0 !==
                o.length && (a = e._doSort(a, 0))
            };
            this._doSort = function (a, b) {
                var d = o[b].by, f = o[b].dir, j = o[b].type, c = o[b].datefmt;
                if (b === o.length - 1)return e._getOrder(a, d, f, j, c);
                b++;
                for (var d = e._getGroup(a, d, f, j, c), f = [], g, j = 0; j < d.length; j++) {
                    g = e._doSort(d[j].items, b);
                    for (c = 0; c < g.length; c++)f.push(g[c])
                }
                return f
            };
            this._getOrder = function (a, d, f, c, g) {
                var h = [], k = [], m = "a" === f ? 1 : -1, n, p;
                void 0 === c && (c = "text");
                p = "float" === c || "number" === c || "currency" === c || "numeric" === c ? function (a) {
                ...
                for (var c = 0, l = a.length; c < l;)f = k[c].index, h.push(a[f]), c++;
                return h
            };
            this._getGroup =
                function (a, d, f, j, c) {
                    var g = [], h = null, i = null, k;
                    b.each(e._getOrder(a, d, f, j, c), function (a, f) {
                        k = b.jgrid.getAccessor(f, d);
                        null == k && (k = "");
                        e._equals(i, k) || (i = k, null !== h && g.push(h), h = e._group(d, k));
                        h.items.push(f)
                    });
                    null !== h && g.push(h);
                    return g
            ...
            this._compareValues = function (a, d, f, j, c) {
                var g;
                g = B ? "jQuery.jgrid.getAccessor(this,'" + d + "')" : "this";
                void 0 === f && (f = null);
                var h = f, k = void 0 === c.stype ? "text" : c.stype;
                if (null !== f)switch (k) {
                    case "int":
                    case "integer":
                        h = isNaN(Number(h)) ||
                    ...
                    case "datetime":
                        ...
                        g = 'jQuery.jgrid.parseDate("' + c.srcfmt + '",' + g + ").getTime()";
                        break;
                    default:
            ...
            this.startsWith = function (a, d) {
                ...
                B ? e._append(e._getStr("jQuery.jgrid.getAccessor(this,'" + a + "')") + ".substr(0," + c + ") == " + e._getStr('"' + e._toStr(d) + '"')) : (c = f ? b.trim(d.toString()).length : d.toString().length, e._append(e._getStr("this") + ".substr(0," + c + ") == " + e._getStr('"' + e._toStr(a) + '"')));
                e._setCommand(e.startsWith, a);
                e._resetNegate();
                return e
            };
            this.endsWith = function (a, d) {
                var c = null == d ? a : d, c = f ? b.trim(c.toString()).length :
                    c.toString().length;
                B ? e._append(e._getStr("jQuery.jgrid.getAccessor(this,'" + a + "')") + ".substr(" + e._getStr("jQuery.jgrid.getAccessor(this,'" + a + "')") + ".length-" + c + "," + c + ') == "' + e._toStr(d) + '"') : e._append(e._getStr("this") + ".substr(" + e._getStr("this") + '.length-"' + e._toStr(a) + '".length,"' + e._toStr(a) + '".length) == "' + e._toStr(a) + '"');
                e._setCommand(e.endsWith, a);
                e._resetNegate();
                return e
            };
            this.contains = function (a, b) {
                B ? e._append(e._getStr("jQuery.jgrid.getAccessor(this,'" + a + "')") + '.indexOf("' + e._toStr(b) +
                    '",0) > -1') : e._append(e._getStr("this") + '.indexOf("' + e._toStr(a) + '",0) > -1');
                e._setCommand(e.contains, a);
                e._resetNegate();
                return e
            };
            this.groupBy = function (b, d, f, c) {
            ...
            this.orderBy = function (a, d, f, c) {
                ...
                o.push({by: a, dir: d, type: f, datefmt: c});
                return e
            };
            return e
        }(d, null)
            ...
            if (!this.grid) {
                var e = b.extend(!0, {url: "", height: 150, page: 1, rowNum: 20, rowTotal: null, records: 0, pager: "", pgbuttons: !0, pginput: !0, colModel: [], rowList: [], colNames: [], sortorder: "asc", sortname: "", datatype: "xml", mtype: "GET",
                    ...
                    scrollrows: !1, autowidth: !1, scrollOffset: 18, cellLayout: 5, subGridWidth: 20, multiselectWidth: 20, gridview: !1, rownumWidth: 25, rownumbers: !1, pagerpos: "center", recordpos: "right", footerrow: !1, userDataOnFooter: !1, hoverrows: !0, altclass: "ui-priority-secondary", viewsortcols: [!1, "vertical", !0], resizeclass: "", autoencode: !1, remapColumns: [], ajaxGridOptions: {}, direction: "ltr", toppager: !1, headertitles: !1, scrollTimeout: 40, data: [], _index: {}, grouping: !1, groupingView: {groupField: [], groupOrder: [], groupText: [], groupColumnShow: [],
                        groupSummary: [], showSummaryOnHide: !1, sortitems: [], sortnames: [], summary: [], summaryval: [], plusicon: "ui-icon-circlesmall-plus", minusicon: "ui-icon-circlesmall-minus", displayField: []}, ignoreCase: !1, cmTemplate: {}, idPrefix: "", multiSort: !1}, b.jgrid.defaults, d || {}), a = this, c = {headers: [], cols: [], footers: [], dragStart: function (c, d, f) {
                    this.resizing = {idx: c, startX: d.clientX, sOL: f[0]};
                    this.hDiv.style.cursor = "col-resize";
                    this.curGbox = b("#rs_m" + b.jgrid.jqID(e.id), "#gbox_" + b.jgrid.jqID(e.id));
                    this.curGbox.css({display: "block",
                        left: f[0], top: f[1], height: f[2]});
                    ...
                    if (a) {
                        ...
                        if (d[0].rows.length)try {
                            g = (f = d[0].rows[1]) ? b(f).outerHeight() || c.prevRowHeight : c.prevRowHeight
                        } catch (h) {
                            g = c.prevRowHeight
                        }
                        if (g) {
                            ...
                            var K = Math.round(d.position().top) - f, k = K + d.height();
                            g *= i;
                            var A, G, w;
                            if (k < a && 0 >= K && (void 0 === e.lastpage || parseInt((k + f + g - 1) / g, 10) <= e.lastpage))G = parseInt((a - k + g - 1) / g, 10), 0 <= k || 2 > G || !0 === e.scroll ? (A = Math.round((k + f) / g) + 1, K = -1) : K = 1;
                            0 < K && (A = parseInt(f / g, 10) + 1, G = parseInt((f + a) / g, 10) + 2 - A, w = !0);
                            if (G && (!e.lastpage || !(A > e.lastpage || 1 === e.lastpage || A === e.page && A === e.lastpage)))c.hDiv.loading ? c.timer = setTimeout(c.populateVisible, e.scrollTimeout) : (e.page = A, w && (c.selectionPreserver(d[0]),
                                c.emptyRows.call(d[0], !1, !1)), c.populate(G))
                        }
                    }
                ...
                if ("TABLE" !== this.tagName.toUpperCase())alert("Element is not a table"); else if (void 0 !== document.documentMode && 5 >= document.documentMode)alert("Grid can not be used in this ('quirks') mode!"); else {
                    ...
                    if (this.p.colNames.length !== this.p.colModel.length)alert(b.jgrid.errors.model); else {
                        ...
                        b(m).attr({id: "gbox_" + this.id, dir: g}).insertBefore(i);
                        b(i).attr("id", "gview_" + this.id).appendTo(m);
                        ...
                        var n = function (a, b) {
                        ...
                        }, p = function (d, e, f, g, h, i) {
                            var K = a.p.colModel[d], k = K.align, A = 'style="', G = K.classes, w = K.name, x = [];
                            k && (A = A + ("text-align:" + k + ";"));
                            K.hidden === true && (A = A + "display:none;");
                            if (e === 0)A = A + ("width: " + c.headers[d].width + "px;"); else if (K.cellattr && b.isFunction(K.cellattr))if ((d = K.cellattr.call(a, h, f, g, K, i)) && typeof d === "string") {
                                d = d.replace(/style/i, "style").replace(/title/i, "title");
                                if (d.indexOf("title") > -1)K.title =
                                    false;
                                d.indexOf("class") > -1 && (G = void 0);
                                x = d.split(/[^-]style/);
                                if (x.length === 2) {
                                    x[1] = b.trim(x[1].replace("=", ""));
                                    if (x[1].indexOf("'") === 0 || x[1].indexOf('"') === 0)x[1] = x[1].substring(1);
                                    A = A + x[1].replace(/'/gi, '"')
                                } else A = A + '"'
                            }
                            if (!x.length) {
                            ...
                            A = A + ((G !== void 0 ? ' class="' + G + '"' : "") + (K.title && f ? ' title="' + b.jgrid.stripHtml(f) + '"' : ""));
                            A = A + (' aria-describedby="' + a.p.id + "_" + w + '"');
                            return A + x[0]
                        }, l = function (c) {
                            return c == null || c === "" ? "&#160;" : a.p.autoencode ? b.jgrid.htmlEncode(c) : "" + c
                        }, o = function (c, d, e, f, g) {
                            ...
                            if (h.formatter !== void 0) {
                                ...
                                d = b.isFunction(h.formatter) ? h.formatter.call(a, d, c, f, g) : b.fmatter ? b.fn.fmatter.call(a, h.formatter, d, c, f, g) : l(d)
                            } else d = l(d);
                            return d
                            ...
                            var j = "-1", i = "", k, d = d ? "display:none;" : "", e = "ui-widget-content jqgrow ui-row-" + a.p.direction +
                                (e ? " " + e : "") + (h ? " ui-state-highlight" : ""), h = b(a).triggerHandler("jqGridRowAttr", [f, g, c]);
                            ...
                            if (b.isXMLDoc(c)) {
                                ...
                                var G = b(a), w, x, m = 0, n, s = a.p.multiselect === true ? 1 : 0, y = 0, p, l = a.p.rownumbers ===
                                    true ? 1 : 0, o, u = [], F, q = {}, z, E, r = [], qa = a.p.altRows === true ? a.p.altclass : "", t;
                                if (a.p.subGrid === true) {
                                    y = 1;
                                    p = b.jgrid.getMethod("addSubGridCell")
                                }
                                i.repeatitems || (u = Z(k));
                                o = a.p.keyIndex === false ? b.isFunction(i.id) ? i.id.call(a, c) : i.id : a.p.keyIndex;
                                if (u.length > 0 && !isNaN(o)) {
                                    a.p.remapColumns && a.p.remapColumns.length && (o = b.inArray(o, a.p.remapColumns));
                                    o = u[o]
                                }
                                k = ("" + o).indexOf("[") === -1 ? u.length ? function (a, c) {
                                    return b(o, a).text() || c
                                } : function (a, c) {
                                    return b(i.cell, a).eq(o).text() || c
                                } : function (a, b) {
                                    return a.getAttribute(o.replace(/[\[\]]/g,
                                        "")) || b
                                };
                                a.p.userData = {};
                                ...
                                var v = c.length, L = 0, C = [], D = parseInt(a.p.rowNum,
                                    10), H = a.p.scroll ? b.jgrid.randId() : 1;
                                if (v > 0 && a.p.page <= 0)a.p.page = 1;
                                if (c && v) {
                                    g && (D = D * (g + 1));
                                    var g = b.isFunction(a.p.afterInsertRow), J = false, I;
                                    if (a.p.grouping) {
                                    ...
                                    for (; L < v;) {
                                        ...
                                        var O = r.length;
                                        r.push("");
                                        l && r.push(M(0, L, a.p.page, a.p.rowNum));
                                        s && r.push(S(E, l, L, false));
                                        y && r.push(p.call(G, s + l, L + e));
                                        if (i.repeatitems) {
                                            F || (F = T(s + y + l));
                                            var N = b.jgrid.getXmlData(z, i.cell,
                                                true);
                                            b.each(F, function (b) {
                                                var c = N[this];
                                                if (!c)return false;
                                                n = c.textContent || c.text;
                                                q[a.p.colModel[b + s + y + l].name] = n;
                                                r.push(B(E, n, b + s + y + l, L + e, z, q))
                                            })
                                        } else for (w = 0; w < u.length; w++) {
                                            n = b.jgrid.getXmlData(z, u[w]);
                                            q[a.p.colModel[w + s + y + l].name] = n;
                                            r.push(B(E, n, w + s + y + l, L + e, z, q))
                                        }
                                        r[O] = W(E, J, t, q, z, false);
                                        r.push("</tr>");
                                        if (a.p.grouping) {
                                            C = I.call(G, r, C, q, L);
                                            r = []
                                        ...
                                        if (j || a.p.treeGrid === true) {
                                            q._id_ = b.jgrid.stripPref(a.p.idPrefix, E);
                                            a.p.data.push(q);
                                        ...
                                        if (a.p.gridview === false) {
                                            b("tbody:first",
                                                d).append(r.join(""));
                                            G.triggerHandler("jqGridAfterInsertRow", [E, q, z]);
                                            g && a.p.afterInsertRow.call(a, E, q, z);
                                            r = []
                                        }
                                        q = {};
                                        m++;
                                ...
                                if (a.p.gridview === true) {
                                    x = a.p.treeANode > -1 ? a.p.treeANode : 0;
                                    if (a.p.grouping) {
                                        G.jqGrid("groupingRender", C, a.p.colModel.length);
                                        C = null
                                    } else a.p.treeGrid === true && x > 0 ? b(a.rows[x]).after(r.join("")) : b("tbody:first", d).append(r.join(""))
                                }
                                if (a.p.subGrid === true)try {
                                    G.jqGrid("addSubGrid", s + l)
                                } catch (Q) {
                                }
                                ...
                                if (a.p.treeGrid === true)try {
                                    G.jqGrid("setTreeNode", x + 1, m + x + 1)
                                } catch (R) {
                                }
                                if (!a.p.treeGrid && !a.p.scroll)a.grid.bDiv.scrollTop = 0;
                                a.p.reccount = m;
                                a.p.treeANode = -1;
                                a.p.userDataOnFooter && G.jqGrid("footerData", "set", a.p.userData, true);
                                if (j) {
                                    a.p.records = v;
                                    a.p.lastpage = Math.ceil(v / D)
                                }
                                ...
                                if (j)for (; m < v;) {
                                    ...
                                    if (i.repeatitems) {
                                        F || (F = T(s + y + l));
                                        var P = b.jgrid.getXmlData(z, i.cell, true);
                                        b.each(F, function (b) {
                                            var c = P[this];
                                            if (!c)return false;
                                            n = c.textContent || c.text;
                            ...
                            if (c) {
                                ...
                                var k = b(a), m = 0, w, x, n, l = [], s = a.p.multiselect ? 1 : 0, y = a.p.subGrid === true ? 1 : 0, p, o = a.p.rownumbers === true ? 1 : 0, u = T(s + y + o);
                                i = Z(i);
                                var v, F, q, z = {}, E, r, t = [], C = a.p.altRows === true ? a.p.altclass : "", D;
                                a.p.page = b.jgrid.getAccessor(c, d.page) || a.p.page || 0;
                                F = b.jgrid.getAccessor(c, d.total);
                                y && (p = b.jgrid.getMethod("addSubGridCell"));
                                a.p.lastpage = F === void 0 ? 1 : F;
                                ...
                                if (!d.repeatitems) {
                                    l = i;
                                    if (l.length > 0 && !isNaN(q)) {
                                        a.p.remapColumns && a.p.remapColumns.length && (q = b.inArray(q, a.p.remapColumns));
                                        q = l[q]
                                    }
                                }
                                F = b.jgrid.getAccessor(c, d.root);
                                F == null && b.isArray(c) && (F = c);
                                F || (F = []);
                                c = F.length;
                                x = 0;
                                ...
                                for (; x < c;) {
                                    g = F[x];
                                    r = b.jgrid.getAccessor(g, q);
                                    if (r === void 0) {
                                        typeof q === "number" && a.p.colModel[q + s + y + o] != null && (r = b.jgrid.getAccessor(g, a.p.colModel[q + s + y + o].name));
                                        if (r === void 0) {
                                            r = H + x;
                                            if (l.length === 0 && d.cell) {
                                                w = b.jgrid.getAccessor(g, d.cell) || g;
                                                r = w != null && w[q] !== void 0 ? w[q] : r
                                            }
                                        }
                                    }
                                    r = a.p.idPrefix + r;
                                    ...
                                    var R = t.length;
                                    t.push("");
                                    o && t.push(M(0, x, a.p.page, a.p.rowNum));
                                    s && t.push(S(r, o, x, I));
                                    y && t.push(p.call(k, s + o, x + e));
                                    v = i;
                                    if (d.repeatitems) {
                                    ...
                                    for (n = 0; n < v.length; n++) {
                                        w = b.jgrid.getAccessor(g, v[n]);
                                        z[a.p.colModel[n + s + y + o].name] = w;
                                        t.push(B(r, w, n + s + y + o, x + e, g, z))
                                    }
                                    t[R] = W(r, P, D, z, g, I);
                                    t.push("</tr>");
                                    if (a.p.grouping) {
                                    ...
                                    if (j || a.p.treeGrid === true) {
                                        z._id_ = b.jgrid.stripPref(a.p.idPrefix, r);
                                        a.p.data.push(z);
                                        a.p._index[z._id_] =
                                            a.p.data.length - 1
                                    }
                                    if (a.p.gridview === false) {
                                        b("#" + b.jgrid.jqID(a.p.id) + " tbody:first").append(t.join(""));
                                        k.triggerHandler("jqGridAfterInsertRow", [r, z, g]);
                                        O && a.p.afterInsertRow.call(a, r, z, g);
                                        t = []
                                    }
                                    z = {};
                                    m++;
                                ...
                                if (a.p.gridview === true) {
                                    ...
                                    a.p.grouping ? k.jqGrid("groupingRender", N, a.p.colModel.length) : a.p.treeGrid === true && E > 0 ? b(a.rows[E]).after(t.join("")) : b("#" + b.jgrid.jqID(a.p.id) + " tbody:first").append(t.join(""))
                                }
                                if (a.p.subGrid === true)try {
                                    k.jqGrid("addSubGrid",
                                            s + o)
                                ...
                                if (a.p.treeGrid === true)try {
                                    k.jqGrid("setTreeNode", E + 1, m + E + 1)
                                } catch (V) {
                                }
                                if (!a.p.treeGrid && !a.p.scroll)a.grid.bDiv.scrollTop = 0;
                                a.p.reccount = m;
                                ...
                                if (j)for (; m < c && F[m];) {
                                    ...
                                    r = b.jgrid.getAccessor(g, q);
                                    if (r === void 0) {
                                        typeof q === "number" && a.p.colModel[q + s + y + o] != null &&
                                        (r = b.jgrid.getAccessor(g, a.p.colModel[q + s + y + o].name));
                                        if (r === void 0) {
                                            r = H + m;
                                            if (l.length === 0 && d.cell) {
                                    ...
                                    if (g) {
                                        ...
                                        for (n = 0; n < v.length; n++)z[a.p.colModel[n + s + y + o].name] = b.jgrid.getAccessor(g, v[n]);
                                        z._id_ = b.jgrid.stripPref(a.p.idPrefix, r);
                                        a.p.data.push(z);
                                        a.p._index[z._id_] = a.p.data.length - 1;
                                        z = {}
                                    }
                                    m++
                                }
                            ...
                            function c(a) {
                                ...
                                if (a.rules != null)try {
                                    (f = a.rules.length && a.groupOp.toString().toUpperCase() === "OR") && s.orBegin();
                                    for (d = 0; d < a.rules.length; d++) {
                                        i = a.rules[d];
                                        h = a.groupOp.toString().toUpperCase();
                                        if (o[i.op] && i.field) {
                                            b > 0 && h && h === "OR" && (s = s.or());
                                            s = o[i.op](s, h)(i.field, i.data, g[i.field])
                                        }
                                        b++
                                    }
                                    f && s.orEnd()
                            ...
                            var d = a.p.multiSort ? [] : "", e = [], f = false, g = {}, h = [], i = [], j, k, m;
                            if (b.isArray(a.p.data)) {
                                var n = a.p.grouping ? a.p.groupingView : false, x, l;
                                b.each(a.p.colModel, function () {
                                    ...
                                    if (k === "date" || k === "datetime") {
                                        if (this.formatter && typeof this.formatter === "string" && this.formatter === "date") {
                                            ...
                                            m = this.formatoptions && this.formatoptions.newformat ? this.formatoptions.newformat : b.jgrid.formatter.date.newformat
                                        } else j =
                                            m = this.datefmt || "Y-m-d";
                                        g[this.name] = {stype: k, srcfmt: j, newfmt: m}
                                    } else g[this.name] = {stype: k, srcfmt: "", newfmt: ""};
                                    if (a.p.grouping) {
                                        l = 0;
                                        for (x = n.groupField.length; l < x; l++)if (this.name === n.groupField[l]) {
                                            var c = this.name;
                                    ...
                                    } else if (!f && (this.index === a.p.sortname || this.name === a.p.sortname)) {
                                        d = this.name;
                                        f = true
                                    }
                                });
                                if (a.p.treeGrid)b(a).jqGrid("SortTree", d, a.p.sortorder, g[d].stype,
                                    g[d].srcfmt); else {
                                    var o = {eq: function (a) {
                                        return a.equals
                                    }, ne: function (a) {
                                    ...
                                    if (a.p.search === true) {
                                        ...
                                        if (y) {
                                            typeof y === "string" && (y = b.jgrid.parse(y));
                                            c(y)
                                        } else try {
                                            s = o[a.p.postData.searchOper](s)(a.p.postData.searchField, a.p.postData.searchString,
                                                g[a.p.postData.searchField])
                                        } catch (p) {
                                        }
                                    }
                                    if (a.p.grouping)for (l = 0; l < x; l++)s.orderBy(i[l], n.groupOrder[l], h[l].stype, h[l].srcfmt);
                                    a.p.multiSort ? b.each(d, function (a) {
                                        s.orderBy(this, e[a], g[this].stype, g[this].srcfmt)
                                    }) : d && a.p.sortorder && f && (a.p.sortorder.toUpperCase() === "DESC" ? s.orderBy(a.p.sortname, "d", g[d].stype, g[d].srcfmt) : s.orderBy(a.p.sortname, "a", g[d].stype, g[d].srcfmt));
                                    var y = s.select(), t = parseInt(a.p.rowNum, 10), u = y.length, v = parseInt(a.p.page, 10), B = Math.ceil(u / t), q = {}, y = y.slice((v - 1) * t, v * t), g =
                                        s = null;
                                    q[a.p.localReader.total] = B;
                                    q[a.p.localReader.page] = v;
                                    q[a.p.localReader.records] = u;
                                    q[a.p.localReader.root] = y;
                            ...
                            if (!a.grid.hDiv.loading) {
                                ...
                                if (!(e === false || e === "stop"))if (b.isFunction(a.p.datatype))a.p.datatype.call(a, a.p.postData, "load_" + a.p.id); else {
                                    ...
                                    switch (f) {
                                        ...
                                        case "xml":
                                        case "script":
                                            b.ajax(b.extend({url: a.p.url, type: a.p.mtype, dataType: f, data: b.isFunction(a.p.serializeGridData) ?
                                                a.p.serializeGridData.call(a, a.p.postData) : a.p.postData, success: function (e, g, h) {
                                                if (b.isFunction(a.p.beforeProcessing) && a.p.beforeProcessing.call(a, e, g, h) === false)P(); else {
                                                    f === "xml" ? J(e, a.grid.bDiv, o, c > 1, j) : R(e, a.grid.bDiv, o, c > 1, j);
                            ...
                            var d, e = "", f = a.p.colModel, g = false, h = a.grid.headers[c].el, i = "";
                            b("span.ui-grid-ico-sort", h).addClass("ui-state-disabled");
                            b(h).attr("aria-selected", "false");
                            if (f[c].lso)if (f[c].lso === "asc") {
                                f[c].lso =
                                    f[c].lso + "-desc";
                                i = "desc"
                            ...
                            } else f[c].lso = i = f.firstsortorder || "asc";
                            if (i) {
                                b("span.s-ico", h).show();
                                b("span.ui-icon-" + i, h).removeClass("ui-state-disabled");
                                b(h).attr("aria-selected", "true")
                            } else a.p.viewsortcols[0] || b("span.s-ico", h).hide();
                            a.p.sortorder = "";
                            b.each(f, function (b) {
                                if (this.lso) {
                                    b > 0 && g && (e = e + ", ");
                                    d = this.lso.split("-");
                                    e = e + (f[b].index || f[b].name);
                                    e = e + (" " + d[d.length -
                                        1]);
                                    g = true;
                                    a.p.sortorder = d[d.length - 1]
                                }
                            });
                            c = e.lastIndexOf(a.p.sortorder);
                            e = e.substring(0, c);
                            a.p.sortname = e
                        }, ka = function (c, d, e, f) {
                            if (a.p.colModel[d].sortable) {
                                ...
                                if (!(a.p.savedRow.length > 0)) {
                                    ...
                                    if (a.p.multiSort)ra(d, e, g); else {
                                        if (f) {
                                    ...
                                    if (b(a).triggerHandler("jqGridSortCol", [c, d, g]) === "stop")a.p.lastsort = d; else if (b.isFunction(a.p.onSortCol) &&
                                        a.p.onSortCol.call(a, c, d, g) === "stop")a.p.lastsort = d; else {
                                        if (a.p.datatype === "local")a.p.deselectAfterSort && b(a).jqGrid("resetSelection"); else {
                                            a.p.selrow = null;
                                            a.p.multiselect && ba(false);
                                            a.p.selarrrow = [];
                                            a.p.savedRow = []
                                        }
                                        if (a.p.scroll) {
                        ...
                        this.p.multiselect &&
                        (this.p.colNames.unshift("<input role='checkbox' id='cb_" + this.p.id + "' class='cbox' type='checkbox'/>"), this.p.colModel.unshift({name: "cb", width: b.jgrid.cell_width ? a.p.multiselectWidth + a.p.cellLayout : a.p.multiselectWidth, sortable: !1, resizable: !1, hidedlg: !0, search: !1, align: "center", fixed: !0}));
                        ...
                        a.p.xmlReader = b.extend(!0, {root: "rows",
                        ...
                        a.p.localReader = b.extend(!0, {root: "rows", page: "page", total: "total", records: "records", repeatitems: !1,
                            cell: "cell", id: "id", userdata: "userdata", subgrid: {root: "rows", repeatitems: !0, cell: "cell"}}, a.p.localReader);
                        a.p.scroll && (a.p.pgbuttons = !1, a.p.pginput = !1, a.p.rowList = []);
                        a.p.data.length && N();
                        var C = "<thead><tr class='ui-jqgrid-labels' role='rowheader'>", ma, D, ca, da, ea, t, u, V, na = V = "", aa = [], oa = [];
                        D = [];
                        if (!0 === a.p.shrinkToFit && !0 === a.p.forceFit)for (f = a.p.colModel.length - 1; 0 <= f; f--)if (!a.p.colModel[f].hidden) {
                            a.p.colModel[f].resizable = !1;
                            break
                        }
                        "horizontal" === a.p.viewsortcols[1] && (V = " ui-i-asc", na = " ui-i-desc");
                        ma = k ? "class='ui-th-div-ie'" : "";
                        V = "<span class='s-ico' style='display:none'><span sort='asc' class='ui-grid-ico-sort ui-icon-asc" + V + " ui-state-disabled ui-icon ui-icon-triangle-1-n ui-sort-" + g + "'></span>" + ("<span sort='desc' class='ui-grid-ico-sort ui-icon-desc" + na + " ui-state-disabled ui-icon ui-icon-triangle-1-s ui-sort-" + g + "'></span></span>");
                        if (a.p.multiSort) {
                            aa = a.p.sortname.split(",");
                            for (f = 0; f < aa.length; f++)D = b.trim(aa[f]).split(" "), aa[f] = b.trim(D[0]), oa[f] = D[1] ? b.trim(D[1]) : a.p.sortorder || "asc"
                        }
                        for (f =
                                 0; f < this.p.colNames.length; f++)D = a.p.headertitles ? ' title="' + b.jgrid.stripHtml(a.p.colNames[f]) + '"' : "", C += "<th id='" + a.p.id + "_" + a.p.colModel[f].name + "' role='columnheader' class='ui-state-default ui-th-column ui-th-" + g + "'" + D + ">", D = a.p.colModel[f].index || a.p.colModel[f].name, C += "<div id='jqgh_" + a.p.id + "_" + a.p.colModel[f].name + "' " + ma + ">" + a.p.colNames[f], a.p.colModel[f].width = a.p.colModel[f].width ? parseInt(a.p.colModel[f].width, 10) : 150, "boolean" !== typeof a.p.colModel[f].title && (a.p.colModel[f].title = !0), a.p.colModel[f].lso = "", D === a.p.sortname && (a.p.lastsort = f), a.p.multiSort && (D = b.inArray(D, aa), -1 !== D && (a.p.colModel[f].lso = oa[D])), C += V + "</div></th>";
                        V = null;
                            ...
                            b("#cb_" + b.jgrid.jqID(a.p.id), this).bind("click", function () {
                                ...
                                if (this.checked) {
                                    b(a.rows).each(function (d) {
                                        if (d >
                                            0 && !b(this).hasClass("ui-subgrid") && !b(this).hasClass("jqgroup") && !b(this).hasClass("ui-state-disabled")) {
                                ...
                                b(a).triggerHandler("jqGridSelectAll", [X ? a.p.selarrrow : fa, X]);
                                b.isFunction(a.p.onSelectAll) && a.p.onSelectAll.call(a, X ? a.p.selarrrow : fa, X)
                            })
                        }
                        !0 === a.p.autowidth && (C = b(m).innerWidth(), a.p.width = 0 < C ? C : "nw");
                        (function () {
                            var d = 0, e = b.jgrid.cell_width ? 0 : n(a.p.cellLayout, 0), f = 0, g, h = n(a.p.scrollOffset, 0), i, k = false, m, l = 0, o = 0, w;
                            b.each(a.p.colModel, function () {
                                ...
                                this.widthOrg = i = n(this.width, 0);
                                if (this.hidden === false) {
                                    d = d + (i + e);
                                    this.fixed ? l = l + (i + e) : f++;
                                    o++
                                }
                            });
                            ...
                            if (a.p.shrinkToFit === true && f > 0) {
                                ...
                                b.each(a.p.colModel, function (b) {
                                    if (this.hidden ===
                                        false && !this.fixed) {
                                        this.width = i = Math.round(m * this.width / (a.p.tblwidth - e * f - l));
                                        d = d + i;
                                        g = b
                                    }
                                });
                                w = 0;
                                k ? c.width - l - (d + e * f) !== h && (w = c.width - l - (d + e * f) - h) : !k && Math.abs(c.width - l - (d + e * f)) !== 1 && (w = c.width - l - (d + e * f));
                                a.p.colModel[g].width = a.p.colModel[g].width + w;
                                a.p.tblwidth = d + w + e * f + l;
                        ...
                        b(m).css("width", c.width + "px").append("<div class='ui-jqgrid-resize-mark' id='rs_m" + a.p.id +
                            "'>&#160;</div>");
                        b(i).css("width", c.width + "px");
                        var C = b("thead:first", a).get(0), Q = "";
                        a.p.footerrow && (Q += "<table role='grid' style='width:" + a.p.tblwidth + "px' class='ui-jqgrid-ftable' cellspacing='0' cellpadding='0' border='0'><tbody><tr role='row' class='ui-widget-content footrow footrow-" + g + "'>");
                        var i = b("tr:first", C), Y = "<tr class='jqgfirstrow' role='row' style='height:auto'>";
                        a.p.disableClick = !1;
                        b("th", i).each(function (d) {
                            ca = a.p.colModel[d].width;
                            if (a.p.colModel[d].resizable === void 0)a.p.colModel[d].resizable =
                                true;
                            if (a.p.colModel[d].resizable) {
                                da = document.createElement("span");
                                b(da).html("&#160;").addClass("ui-jqgrid-resize ui-jqgrid-resize-" + g).css("cursor", "col-resize");
                                b(this).addClass(a.p.resizeclass)
                            } else da = "";
                            b(this).css("width", ca + "px").prepend(da);
                            var e = "";
                            if (a.p.colModel[d].hidden) {
                                b(this).css("display", "none");
                                e = "display:none;"
                            }
                            Y = Y + ("<td role='gridcell' style='height:0px;width:" + ca + "px;" + e + "'></td>");
                            c.headers[d] = {width: ca, el: this};
                            ea = a.p.colModel[d].sortable;
                            if (typeof ea !== "boolean")ea = a.p.colModel[d].sortable =
                                true;
                            e = a.p.colModel[d].name;
                            e === "cb" || e === "subgrid" || e === "rn" || a.p.viewsortcols[2] && b(">div", this).addClass("ui-jqgrid-sortable");
                            if (ea)if (a.p.multiSort)if (a.p.viewsortcols[0]) {
                            ...
                            a.p.footerrow && (Q = Q + ("<td role='gridcell' " + p(d, 0, "", null, "", false) + ">&#160;</td>"))
                        }).mousedown(function (d) {
                            if (b(d.target).closest("th>span.ui-jqgrid-resize").length === 1) {
                                var e = la(this);
                                if (a.p.forceFit === true) {
                                    var f = a.p, g = e, h;
                                    for (h = e + 1; h < a.p.colModel.length; h++)if (a.p.colModel[h].hidden !==
                                        true) {
                                        g = h;
                                        break
                                    }
                        ...
                        var Y = null, i = b("<table class='ui-jqgrid-htable' style='width:" + a.p.tblwidth + "px' role='grid' aria-labelledby='gbox_" + this.id + "' cellspacing='0' cellpadding='0' border='0'></table>").append(C), H = a.p.caption && !0 === a.p.hiddengrid ? !0 : !1;
                        ...
                        i = null;
                        H && b(c.hDiv).hide();
                        a.p.pager && ("string" === typeof a.p.pager ? "#" !== a.p.pager.substr(0, 1) && (a.p.pager = "#" + a.p.pager) : a.p.pager = "#" + b(a.p.pager).attr("id"), b(a.p.pager).css({width: c.width + "px"}).addClass("ui-state-default ui-jqgrid-pager ui-corner-bottom").appendTo(m), H && b(a.p.pager).hide(), ja(a.p.pager, ""));
                        !1 === a.p.cellEdit && !0 === a.p.hoverrows && b(a).bind("mouseover", function (a) {
                            u = b(a.target).closest("tr.jqgrow");
                            b(u).attr("class") !== "ui-subgrid" && b(u).addClass("ui-state-hover")
                        }).bind("mouseout",
                            function (a) {
                                u = b(a.target).closest("tr.jqgrow");
                                b(u).removeClass("ui-state-hover")
                            });
                        var v, I, ga;
                        b(a).before(c.hDiv).click(function (c) {
                            t = c.target;
                            u = b(t, a.rows).closest("tr.jqgrow");
                            if (b(u).length === 0 || u[0].className.indexOf("ui-state-disabled") > -1 || (b(t, a).closest("table.ui-jqgrid-btable").attr("id") || "").replace("_frozen", "") !== a.id)return this;
                            var d = b(t).hasClass("cbox"), e = b(a).triggerHandler("jqGridBeforeSelectRow", [u[0].id, c]);
                            (e = e === false || e === "stop" ? false : true) && b.isFunction(a.p.beforeSelectRow) &&
                            (e = a.p.beforeSelectRow.call(a, u[0].id, c));
                            if (!(t.tagName === "A" || (t.tagName === "INPUT" || t.tagName === "TEXTAREA" || t.tagName === "OPTION" || t.tagName === "SELECT") && !d) && e === true) {
                                v = u[0].id;
                                I = b.jgrid.getCellIndex(t);
                                ga = b(t).closest("td,th").html();
                                b(a).triggerHandler("jqGridCellSelect", [v, I, ga, c]);
                                b.isFunction(a.p.onCellSelect) && a.p.onCellSelect.call(a, v, I, ga, c);
                                if (a.p.cellEdit === true)if (a.p.multiselect && d)b(a).jqGrid("setSelection", v, true, c); else {
                                    v = u[0].rowIndex;
                                    try {
                                        b(a).jqGrid("editCell", v, I, true)
                                    } catch (f) {
                                    }
                                } else if (a.p.multikey)if (c[a.p.multikey])b(a).jqGrid("setSelection",
                                    v, true, c); else {
                                    if (a.p.multiselect && d) {
                                        d = b("#jqg_" + b.jgrid.jqID(a.p.id) + "_" + v).is(":checked");
                                        b("#jqg_" + b.jgrid.jqID(a.p.id) + "_" + v)[a.p.useProp ? "prop" : "attr"]("checked", d)
                                    }
                                } else {
                            ...
                            if (b(u).length !== 0) {
                                ...
                                b(a).triggerHandler("jqGridDblClickRow",
                                    [b(u).attr("id"), v, I, c]);
                                b.isFunction(a.p.ondblClickRow) && a.p.ondblClickRow.call(a, b(u).attr("id"), v, I, c)
                            }
                        }).bind("contextmenu", function (c) {
                            t = c.target;
                            u = b(t, a.rows).closest("tr.jqgrow");
                            if (b(u).length !== 0) {
                                a.p.multiselect || b(a).jqGrid("setSelection", u[0].id, true, c);
                                v = u[0].rowIndex;
                                I = b.jgrid.getCellIndex(t);
                                b(a).triggerHandler("jqGridRightClickRow", [b(u).attr("id"), v, I, c]);
                                b.isFunction(a.p.onRightClickRow) && a.p.onRightClickRow.call(a, b(u).attr("id"), v, I, c)
                            }
                        });
                        c.bDiv = document.createElement("div");
                        k &&
                            "auto" === ("" + a.p.height).toLowerCase() && (a.p.height = "100%");
                        b(c.bDiv).append(b('<div style="position:relative;' + (k && 8 > b.jgrid.msiever() ? "height:0.01%;" : "") + '"></div>').append("<div></div>").append(this)).addClass("ui-jqgrid-bdiv").css({height: a.p.height + (isNaN(a.p.height) ? "" : "px"), width: c.width + "px"}).scroll(c.scrollGrid);
                        ...
                        b(c.cDiv).append(ha).append("<span class='ui-jqgrid-title" +
                            ("rtl" === g ? "-rtl" : "") + "'>" + a.p.caption + "</span>").addClass("ui-jqgrid-titlebar ui-widget-header ui-corner-top ui-helper-clearfix");
                        ...
                        a.p.toolbar[0] && (c.uDiv = document.createElement("div"), "top" === a.p.toolbar[1] ? b(c.uDiv).insertBefore(c.hDiv) : "bottom" === a.p.toolbar[1] && b(c.uDiv).insertAfter(c.hDiv), "both" === a.p.toolbar[1] ? (c.ubDiv = document.createElement("div"), b(c.uDiv).addClass("ui-userdata ui-state-default").attr("id", "t_" + this.id).insertBefore(c.hDiv), b(c.ubDiv).addClass("ui-userdata ui-state-default").attr("id",
                                "tb_" + this.id).insertAfter(c.hDiv), H && b(c.ubDiv).hide()) : b(c.uDiv).width(c.width).addClass("ui-userdata ui-state-default").attr("id", "t_" + this.id), H && b(c.uDiv).hide());
                        a.p.toppager && (a.p.toppager = b.jgrid.jqID(a.p.id) + "_toppager", c.topDiv = b("<div id='" + a.p.toppager + "'></div>")[0], a.p.toppager = "#" + a.p.toppager, b(c.topDiv).addClass("ui-state-default ui-jqgrid-toppager").width(c.width).insertBefore(c.hDiv), ja(a.p.toppager, "_t"));
                        a.p.footerrow && (c.sDiv = b("<div class='ui-jqgrid-sdiv'></div>")[0], f = b("<div class='ui-jqgrid-hbox" +
                            ("rtl" === g ? "-rtl" : "") + "'></div>"), b(c.sDiv).append(f).width(c.width).insertAfter(c.hDiv), b(f).append(Q), c.footers = b(".ui-jqgrid-ftable", c.sDiv)[0].rows[0].cells, a.p.rownumbers && (c.footers[0].className = "ui-state-default jqgrid-rownum"), H && b(c.sDiv).hide());
                        f = null;
                        if (a.p.caption) {
                            var ta = a.p.datatype;
                            !0 === a.p.hidegrid && (b(".ui-jqgrid-titlebar-close", c.cDiv).click(function (d) {
                                ...
                                a.p.gridstate === "visible" ? b(f, "#gbox_" + b.jgrid.jqID(a.p.id)).slideUp("fast", function () {
                                    ...
                                    if (g === 0) {
                                        ...
                                        b(a).triggerHandler("jqGridHeaderClick", [a.p.gridstate,
                                            d]);
                                        e && (H || a.p.onHeaderClick.call(a, a.p.gridstate, d))
                                    }
                                });
                        ...
                        a.updatepager = function (c, d) {
                            var e, f, g, h, i, j, k,
                                m = "", l = a.p.pager ? "_" + b.jgrid.jqID(a.p.pager.substr(1)) : "", o = a.p.toppager ? "_" + a.p.toppager.substr(1) : "";
                            ...
                            if (a.p.scroll) {
                                ...
                                if (e = e.outerHeight() || a.grid.prevRowHeight) {
                                    ...
                                    if (a.grid.bDiv.scrollTop == 0 && a.p.page > 1)a.grid.bDiv.scrollTop =
                                        a.p.rowNum * (a.p.page - 1) * e
                                }
                            ...
                            if (m = m + (a.p.toppager ? m ? "," + a.p.toppager : a.p.toppager : "")) {
                                ...
                                if (a.p.viewrecords)if (a.p.reccount === 0)b(".ui-paging-info",
                                    m).html(a.p.emptyrecords); else {
                                    h = g + 1;
                                    j = a.p.records;
                                    if (b.fmatter) {
                            ...
                            c === true && a.p.rownumbers === true && b(">td.jqgrid-rownum",
                                a.rows).each(function (a) {
                                    b(this).html(g + 1 + a)
                                });
                        ...
                        a.refreshIndex = N;
                        a.setHeadCheckBox = ba;
                        a.constructTr = W;
                        a.formatter = function (a, b, c, d, e) {
                            return o(a, b, c, d, e)
                        };
                        b.extend(c, {populate: O, emptyRows: U});
                        this.grid = c;
    ...
    b.jgrid.extend({getGridParam: function (b) {
        ...
        var d = [], g = 0, c, e = 0;
        this.each(function () {
            if ((c = this.rows.length) && 0 < c)for (; g < c;)b(this.rows[g]).hasClass("jqgrow") &&
            (d[e] = this.rows[g].id, e++), g++
        });
        return d
    }, setSelection: function (d, g, c) {
        return this.each(function () {
            var e, a, j, f, h, i;
            if (void 0 !== d && (g = !1 === g ? !1 : !0, (a = this.rows.namedItem("" + d)) && a.className && !(-1 < a.className.indexOf("ui-state-disabled"))))if (!0 === this.p.scrollrows && (j = this.rows.namedItem(d).rowIndex, 0 <= j && (e = b(this.grid.bDiv)[0].clientHeight, f = b(this.grid.bDiv)[0].scrollTop, h = b(this.rows[j]).position().top, j = this.rows[j].clientHeight, h + j >= e + f ? b(this.grid.bDiv)[0].scrollTop = h - (e + f) + j + f : h < e + f && h < f &&
                (b(this.grid.bDiv)[0].scrollTop = h))), !0 === this.p.frozenColumns && (i = this.p.id + "_frozen"), this.p.multiselect) {
                if (this.setHeadCheckBox(!1), this.p.selrow = a.id, f = b.inArray(this.p.selrow, this.p.selarrrow), -1 === f ? ("ui-subgrid" !== a.className && b(a).addClass("ui-state-highlight").attr("aria-selected", "true"), e = !0, this.p.selarrrow.push(this.p.selrow)) : ("ui-subgrid" !== a.className && b(a).removeClass("ui-state-highlight").attr("aria-selected", "false"), e = !1, this.p.selarrrow.splice(f, 1), h = this.p.selarrrow[0], this.p.selrow =
                    ...
                    a.id, e, c)
            } else if ("ui-subgrid" !== a.className && (this.p.selrow !== a.id ? (b(this.rows.namedItem(this.p.selrow)).removeClass("ui-state-highlight").attr({"aria-selected": "false", tabindex: "-1"}), b(a).addClass("ui-state-highlight").attr({"aria-selected": "true", tabindex: "0"}), i && (b("#" + b.jgrid.jqID(this.p.selrow), "#" + b.jgrid.jqID(i)).removeClass("ui-state-highlight"), b("#" + b.jgrid.jqID(d), "#" + b.jgrid.jqID(i)).addClass("ui-state-highlight")), e = !0) : e = !1, this.p.selrow = a.id, g))b(this).triggerHandler("jqGridSelectRow",
                [a.id, e, c]), this.p.onSelectRow && this.p.onSelectRow.call(this, a.id, e, c)
        })
    }, resetSelection: function (d) {
        return this.each(function () {
            var g = this, c, e, a;
            !0 === g.p.frozenColumns && (a = g.p.id + "_frozen");
            if (void 0 !== d) {
                e = d === g.p.selrow ? g.p.selrow : d;
                b("#" + b.jgrid.jqID(g.p.id) + " tbody:first tr#" + b.jgrid.jqID(e)).removeClass("ui-state-highlight").attr("aria-selected", "false");
                a && b("#" + b.jgrid.jqID(e), "#" + b.jgrid.jqID(a)).removeClass("ui-state-highlight");
                if (g.p.multiselect) {
                    b("#jqg_" + b.jgrid.jqID(g.p.id) + "_" + b.jgrid.jqID(e),
                            "#" + b.jgrid.jqID(g.p.id))[g.p.useProp ? "prop" : "attr"]("checked", !1);
                    if (a)b("#jqg_" + b.jgrid.jqID(g.p.id) + "_" + b.jgrid.jqID(e), "#" + b.jgrid.jqID(a))[g.p.useProp ? "prop" : "attr"]("checked", !1);
                    g.setHeadCheckBox(!1)
                }
                e = null
            } else g.p.multiselect ? (b(g.p.selarrrow).each(function (d, e) {
                c = g.rows.namedItem(e);
                b(c).removeClass("ui-state-highlight").attr("aria-selected", "false");
                b("#jqg_" + b.jgrid.jqID(g.p.id) + "_" + b.jgrid.jqID(e))[g.p.useProp ? "prop" : "attr"]("checked", !1);
                a && (b("#" + b.jgrid.jqID(e), "#" + b.jgrid.jqID(a)).removeClass("ui-state-highlight"),
                    b("#jqg_" + b.jgrid.jqID(g.p.id) + "_" + b.jgrid.jqID(e), "#" + b.jgrid.jqID(a))[g.p.useProp ? "prop" : "attr"]("checked", !1))
            }), g.setHeadCheckBox(!1), g.p.selarrrow = []) : g.p.selrow && (b("#" + b.jgrid.jqID(g.p.id) + " tbody:first tr#" + b.jgrid.jqID(g.p.selrow)).removeClass("ui-state-highlight").attr("aria-selected", "false"), a && b("#" + b.jgrid.jqID(g.p.selrow), "#" + b.jgrid.jqID(a)).removeClass("ui-state-highlight"), g.p.selrow = null);
            !0 === g.p.cellEdit && 0 <= parseInt(g.p.iCol, 10) && 0 <= parseInt(g.p.iRow, 10) && (b("td:eq(" + g.p.iCol +
                ")", g.rows[g.p.iRow]).removeClass("edit-cell ui-state-highlight"), b(g.rows[g.p.iRow]).removeClass("selected-row ui-state-hover"));
            g.p.savedRow = []
        })
        ...
        this.each(function () {
            ...
            if (void 0 === d)e = !0, c = [], a = f.rows.length; else {
                i = f.rows.namedItem(d);
                if (!i)return g;
                a = 2
            }
            for (; j < a;)e && (i = f.rows[j]), b(i).hasClass("jqgrow") && (b('td[role="gridcell"]', i).each(function (a) {
                h = f.p.colModel[a].name;
                if ("cb" !== h && "subgrid" !== h && "rn" !== h)if (!0 === f.p.treeGrid && h === f.p.ExpandColumn)g[h] =
                    b.jgrid.htmlDecode(b("span:first", this).html()); else try {
                    g[h] = b.unformat.call(f, this, {rowId: i.id, colModel: f.p.colModel[a]}, a)
                } catch (c) {
        ...
        this.each(function () {
            ...
            this.p.selrow = this.p.multiselect &&
                0 < this.p.selarrrow.length ? this.p.selarrrow[this.p.selarrrow.length - 1] : null;
        ...
        this.each(function () {
            ...
            if (g)try {
                if (b(this.p.colModel).each(function (a) {
                    ...
                    void 0 !== c && (m[e] = this.formatter && "string" === typeof this.formatter && "date" === this.formatter ? b.unformat.date.call(f, c, this) : c, h = f.formatter(d, c, a, g, "edit"), j = this.title ? {title: b.jgrid.stripHtml(h)} : {}, !0 === f.p.treeGrid && e === f.p.ExpandColumn ? b("td[role='gridcell']:eq(" + a + ") > span:first", i).html(h).attr(j) : b("td[role='gridcell']:eq(" + a + ")", i).html(h).attr(j))
                }), "local" === f.p.datatype) {
                    var n = b.jgrid.stripPref(f.p.idPrefix,
                        d), p = f.p._index[n], l;
                    if (f.p.treeGrid)for (l in f.p.treeReader)f.p.treeReader.hasOwnProperty(l) && delete m[f.p.treeReader[l]];
                    void 0 !== p && (f.p.data[p] = b.extend(!0, f.p.data[p], m));
                    m = null
                }
            } catch (o) {
                a = !1
            }
            a && ("string" === k ? b(i).addClass(c) : "object" === k && b(i).css(c), b(f).triggerHandler("jqGridAfterGridComplete"))
        });
        return a
    }, addRowData: function (d, g, c, e) {
        c || (c = "last");
        var a = !1, j, f, h, i, k, m, n, p, l = "", o, B, S, M, Z, T;
        g && (b.isArray(g) ? (o = !0, c = "last", B = d) : (g = [g], o = !1), this.each(function () {
            var U = g.length;
            k = this.p.rownumbers ===
                true ? 1 : 0;
            h = this.p.multiselect === true ? 1 : 0;
            i = this.p.subGrid === true ? 1 : 0;
            if (!o)if (d !== void 0)d = "" + d; else {
                d = b.jgrid.randId();
                if (this.p.keyIndex !== false) {
                    B = this.p.colModel[this.p.keyIndex + h + i + k].name;
                    g[0][B] !== void 0 && (d = g[0][B])
                }
            }
            S = this.p.altclass;
            for (var N = 0, W = "", J = {}, R = b.isFunction(this.p.afterInsertRow) ? true : false; N < U;) {
                M = g[N];
                f = [];
                if (o) {
                    try {
                    ...
                    W = this.p.altRows === true ? (this.rows.length - 1) % 2 === 0 ? S : "" : ""
                }
                T = d;
                d = this.p.idPrefix + d;
                if (k) {
                    l =
                        this.formatCol(0, 1, "", null, d, true);
                    f[f.length] = '<td role="gridcell" class="ui-state-default jqgrid-rownum" ' + l + ">0</td>"
                }
                if (h) {
                    p = '<input role="checkbox" type="checkbox" id="jqg_' + this.p.id + "_" + d + '" class="cbox"/>';
                    l = this.formatCol(k, 1, "", null, d, true);
                    f[f.length] = '<td role="gridcell" ' + l + ">" + p + "</td>"
                }
                i && (f[f.length] = b(this).jqGrid("addSubGridCell", h + k, 1));
                for (n = h + i + k; n < this.p.colModel.length; n++) {
                    Z = this.p.colModel[n];
                    j = Z.name;
                    J[j] = M[j];
                    p = this.formatter(d, b.jgrid.getAccessor(M, j), n, M);
                    l = this.formatCol(n,
                        1, p, M, d, J);
                    f[f.length] = '<td role="gridcell" ' + l + ">" + p + "</td>"
                }
                f.unshift(this.constructTr(d, false, W, J, M, false));
                f[f.length] = "</tr>";
                if (this.rows.length === 0)b("table:first", this.grid.bDiv).append(f.join("")); else switch (c) {
                    ...
                    case "first":
                        ...
                        break;
                    case "after":
                        (m = this.rows.namedItem(e)) && (b(this.rows[m.rowIndex + 1]).hasClass("ui-subgrid") ? b(this.rows[m.rowIndex + 1]).after(f) : b(m).after(f.join("")));
                        m++;
                        break;
                    case "before":
                        if (m = this.rows.namedItem(e)) {
                            b(m).before(f.join(""));
                            m = m.rowIndex
                        }
                        m--
                ...
                R && this.p.afterInsertRow.call(this, d, M, M);
                N++;
                if (this.p.datatype === "local") {
                    J[this.p.localReader.id] = T;
                    this.p._index[T] = this.p.data.length;
                    this.p.data.push(J);
                    J = {}
                }
            }
            this.p.altRows === true && !o && (c === "last" ? (this.rows.length - 1) % 2 === 1 && b(this.rows[this.rows.length -
                1]).addClass(S) : b(this.rows).each(function (a) {
                a % 2 === 1 ? b(this).addClass(S) : b(this).removeClass(S)
            }));
        ...
        this.each(function () {
            var i = this, k;
            if (!i.grid || !i.p.footerrow || "set" === d && e(g))return!1;
            j = !0;
            b(this.p.colModel).each(function (e) {
                a = this.name;
                "set" === d ? void 0 !== g[a] && (k = c ?
                    i.formatter("", g[a], e, g, "edit") : g[a], h = this.title ? {title: b.jgrid.stripHtml(k)} : {}, b("tr.footrow td:eq(" + e + ")", i.grid.sDiv).html(k).attr(h), j = !0) : "get" === d && (f[a] = b("tr.footrow td:eq(" + e + ")", i.grid.sDiv).html())
            })
        });
        return"get" === d ? f : j
                ...
                b(this.p.colModel).each(function (h) {
                    if (-1 !== b.inArray(this.name, d) && this.hidden === f) {
                        ...
                        b(c.rows).each(function () {
                            b(this).hasClass("jqgroup") || b(this.cells[h]).css("display", g)
                        });
                        c.p.footerrow && b("tr.footrow td:eq(" + h + ")", c.grid.sDiv).css("display", g);
                        j = parseInt(this.width, 10);
                        c.p.tblwidth = "none" === g ? c.p.tblwidth - (j + a) : c.p.tblwidth + (j + a);
                        this.hidden = !f;
                        e = !0;
        ...
        g && a(b("#" + b.jgrid.jqID(j.p.id) + " tbody:first"), ".jqgfirstrow, tr.jqgrow, tr.jqfoot");
        ...
        b(j).triggerHandler("jqGridRemapColumns", [d, g, c])
    }, setGridWidth: function (d, g) {
        return this.each(function () {
            if (this.grid) {
                var c = this, e, a = 0, j = b.jgrid.cell_width ? 0 : c.p.cellLayout, f, h = 0, i = !1, k = c.p.scrollOffset, m, n = 0, p = 0, l;
                "boolean" !== typeof g && (g = c.p.shrinkToFit);
                if (!isNaN(d)) {
                    d = parseInt(d, 10);
                    c.grid.width = c.p.width =
                        d;
                    ...
                    if (!0 === g) {
                        ...
                        c.p.tblwidth = a;
                        m = d - j * h - n;
                        if (!isNaN(c.p.height) && (b(c.grid.bDiv)[0].clientHeight < b(c.grid.bDiv)[0].scrollHeight || 1 === c.rows.length))i = !0, m -= k;
                        var a = 0, o = 0 < c.grid.cols.length;
                        b.each(c.p.colModel, function (b) {
                            if (this.hidden === false && !this.fixed) {
                                e = this.widthOrg;
                                e = Math.round(m * e / (c.p.tblwidth - j * h - n));
                                if (!(e < 0)) {
                                    this.width = e;
                                    a = a + e;
                                    ...
                                    if (o)c.grid.cols[b].style.width = e + "px";
                                    f = b
                                }
                            }
                        });
                        if (!f)return;
                        l = 0;
                        i ? d - n - (a + j * h) !== k && (l = d - n - (a + j * h) - k) : 1 !== Math.abs(d - n - (a + j * h)) && (l = d - n - (a + j * h));
                        c.p.colModel[f].width += l;
                        c.p.tblwidth = a + l + j * h + n;
                        c.p.tblwidth > d ? (i = c.p.tblwidth - parseInt(d, 10), c.p.tblwidth = d, e = c.p.colModel[f].width -= i) : e = c.p.colModel[f].width;
                        c.grid.headers[f].width = e;
                        c.grid.headers[f].el.style.width = e + "px";
                        o && (c.grid.cols[f].style.width = e + "px");
                        c.p.footerrow && (c.grid.footers[f].style.width =
                            e + "px")
                    }
        ...
        return this.each(function () {
            ...
            if (this.grid && void 0 !== d && (b(this.p.colModel).each(function (b) {
                ...
                if (g) {
                    var f = b(".s-ico", j);
                    b("[id^=jqgh_]", j).empty().html(g).append(f);
                    this.p.colNames[a] = g
                }
    ...
    }, setCell: function (d, g, c, e, a, j) {
        return this.each(function () {
            var f = -1, h, i;
            if (this.grid && (isNaN(g) ? b(this.p.colModel).each(function (a) {
                if (this.name === g)return f = a, !1
            }) : f = parseInt(g, 10), 0 <= f && (h = this.rows.namedItem(d)))) {
                var k = b("td:eq(" + f + ")", h);
                if ("" !== c || !0 === j)h = this.formatter(d, c, f, h, "edit"), i = this.p.colModel[f].title ? {title: b.jgrid.stripHtml(h)} : {}, this.p.treeGrid && 0 < b(".tree-wrap", b(k)).length ?
                    b("span", b(k)).html(h).attr(i) : b(k).html(h).attr(i), "local" === this.p.datatype && (h = this.p.colModel[f], c = h.formatter && "string" === typeof h.formatter && "date" === h.formatter ? b.unformat.date.call(this, c, h) : c, i = this.p._index[b.jgrid.stripPref(this.p.idPrefix, d)], void 0 !== i && (this.p.data[i][h.name] = c));
        ...
        var e = [], a, j = 0, f, h, i, g = "boolean" !== typeof g ? !1 : g;
        void 0 === c && (c = !1);
        this.each(function () {
            var k = -1;
                ...
                if (m && 0 < m) {
                    for (; n < m;) {
                        if (b(this.rows[n]).hasClass("jqgrow")) {
                            ...
                            c ? (i = parseFloat(a), j += i, void 0 === h && (h = f = i), f = Math.min(f, i), h = Math.max(h, i)) : g ? e.push({id: this.rows[n].id, value: a}) : e.push(a)
                        }
                        n++
                    }
        ...
        clearGridData: function (d) {
            return this.each(function () {
                if (this.grid) {
                    ...
                    if (this.p.deepempty)b("#" + b.jgrid.jqID(this.p.id) + " tbody:first tr:gt(0)").remove(); else {
                        ...
                        b("#" + b.jgrid.jqID(this.p.id) + " tbody:first").empty().append(g)
                    }
            ...
            var c = !1, e;
            this.each(function () {
                (e = this.rows.namedItem(b)) && (c = !0 === g ? e : e.rowIndex)
            });
            return c
        }, bindKeys: function (d) {
            var g = b.extend({onEnter: null, onSpace: null, onLeftKey: null, onRightKey: null, scrollingRows: !0}, d || {});
            return this.each(function () {
                var c = this;
                b("body").is("[role]") || b("body").attr("role", "application");
                c.p.scrollrows = g.scrollingRows;
                b(c).keydown(function (d) {
                    var a = b(c).find("tr[tabindex=0]")[0], j, f, h, i = c.p.treeReader.expanded_field;
                    if (a)if (h = c.p._index[b.jgrid.stripPref(c.p.idPrefix, a.id)], 37 === d.keyCode || 38 === d.keyCode || 39 === d.keyCode || 40 === d.keyCode) {
                        ...
                        37 === d.keyCode && (c.p.treeGrid && c.p.data[h][i] && b(a).find("div.treeclick").trigger("click"), b(c).triggerHandler("jqGridKeyLeft", [c.p.selrow]), b.isFunction(g.onLeftKey) && g.onLeftKey.call(c, c.p.selrow));
                        39 === d.keyCode && (c.p.treeGrid && !c.p.data[h][i] && b(a).find("div.treeclick").trigger("click"), b(c).triggerHandler("jqGridKeyRight", [c.p.selrow]), b.isFunction(g.onRightKey) && g.onRightKey.call(c, c.p.selrow))
                    } else 13 === d.keyCode ? (b(c).triggerHandler("jqGridKeyEnter",
                        [c.p.selrow]), b.isFunction(g.onEnter) && g.onEnter.call(c, c.p.selrow)) : 32 === d.keyCode && (b(c).triggerHandler("jqGridKeySpace", [c.p.selrow]), b.isFunction(g.onSpace) && g.onSpace.call(c, c.p.selrow))
                })
            })
        }, unbindKeys: function () {
            return this.each(function () {
...
(function (a) {
    a.jgrid.extend({getColProp: function (a) {
        var c = {}, d = this[0];
        if (!d.grid)return!1;
        var d = d.p.colModel, j;
        for (j = 0; j < d.length; j++)if (d[j].name === a) {
            c = d[j];
            break
        }
        return c
        ...
        return this.each(function () {
            if (this.grid && c) {
                var d = this.p.colModel, j;
                for (j = 0; j < d.length; j++)if (d[j].name === b) {
                    a.extend(!0, this.p.colModel[j], c);
                    break
                }
            }
        })
        ...
        return this.each(function () {
            ...
            if (this.grid) {
                a || (a = this.p.sortname);
                for (h = 0; h < this.p.colModel.length; h++)if (this.p.colModel[h].index ===
                    a || this.p.colModel[h].name === a) {
                    j = h;
                    break
                }
                -1 !== j && (h = this.p.colModel[j].sortable, "boolean" !== typeof h && (h = !0), "boolean" !== typeof c && (c = !1), h && this.sortData("jqgh_" + this.p.id + "_" + a, j, c, d))
            }
        })
        ...
        setGridState: function (b) {
                ...
                if (!this.ftoolbar) {
                    var d = function () {
                        ...
                        a.each(c.p.colModel, function () {
                            ...
                            f = b.searchOperators ? i.parent().prev().children("a").attr("soper") || b.defaultSearch : this.searchoptions && this.searchoptions.sopt ?
                                this.searchoptions.sopt[0] : "select" === this.stype ? "eq" : b.defaultSearch;
                            if ((g = "custom" === this.stype && a.isFunction(this.searchoptions.custom_value) && 0 < i.length && "SPAN" === i[0].nodeName.toUpperCase() ? this.searchoptions.custom_value.call(c, i.children(".customelement:first"), "get") : i.val()) || "nu" === f || "nn" === f)d[l] = g, h[l] = f, e++; else try {
                        ...
                        if (!0 === b.stringResult || "local" === c.p.datatype) {
                            var m = '{"groupOp":"' + b.groupOp + '","rules":[', j = 0;
                            ...
                            m += "]}";
                            a.extend(c.p.postData, {filters: m});
                        ...
                        var n;
                        c.p.searchurl && (n = c.p.url, a(c).jqGrid("setGridParam", {url: c.p.searchurl}));
                        var p = "stop" === a(c).triggerHandler("jqGridToolbarBeforeSearch") ? !0 : !1;
                        !p && a.isFunction(b.beforeSearch) &&
                        (p = b.beforeSearch.call(c));
                        p || a(c).jqGrid("setGridParam", {search: i}).trigger("reloadGrid", [
                            {page: 1}
                        ]);
                        ...
                        a("#sopt_menu").remove();
                        var e = parseInt(e, 10), g = parseInt(g, 10) + 18, e = '<ul id="sopt_menu" class="ui-search-menu" role="menu" tabindex="0" style="font-size:' + (a(".ui-jqgrid-view").css("font-size") || "11px") + ";left:" + e + "px;top:" + g + 'px;">', l = c.p.colModel[parseInt(a(k).attr("colindex"))],
                            g = a(k).attr("soper"), f = [], h, i, m = a.extend({}, l.searchoptions);
                        m.sopt || (m.sopt = [], m.sopt[0] = "select" === l.stype ? "eq" : b.defaultSearch);
                        a.each(b.odata, function () {
                            f.push(this.oper)
                        });
                        for (h = 0; h < m.sopt.length; h++)i = a.inArray(m.sopt[h], f), -1 !== i && (l = g === b.odata[i].oper ? "ui-state-highlight" : "", e += '<li class="ui-menu-item ' + l + '" role="presentation"><a href="#" class="ui-corner-all g-menu-item" tabindex="0" role="menuitem" value="' + b.odata[i].oper + '" oper="' + b.operands[b.odata[i].oper] + '"><table cellspacing="0" cellpadding="0" border="0"><tr><td width="25px">' +
                            b.operands[b.odata[i].oper] + "</td><td>" + b.odata[i].text + "</td></tr></table></a></li>");
                        a("body").append(e + "</ul>");
                        ...
                        a("#sopt_menu > li > a").hover(function () {
                            ...
                            var g = a(this).attr("value"), e = a(this).attr("oper");
                            a(c).triggerHandler("jqGridToolbarSelectOper", [g, e, k]);
                            a("#sopt_menu").hide();
                            a(k).text(e).attr("soper", g);
                            if (b.autosearch ===
                                true) {
                                e = a(k).parent().next().children()[0];
                                (a(e).val() || g === "nu" || g === "nn") && d()
                            }
                        })
                    }, h = a("<tr class='ui-search-toolbar' role='rowheader'></tr>"), f;
                    a.each(c.p.colModel, function (k) {
                        var e = this, g, l;
                        l = "";
                        var j = "=", s = a("<th role='columnheader' class='ui-state-default ui-th-column ui-th-" + c.p.direction + "'></th>"), i = a("<div style='position:relative;height:100%;padding-right:0.3em;padding-left:0.3em;'></div>"), m = a("<table class='ui-search-table' cellspacing='0'><tr><td class='ui-search-oper'></td><td class='ui-search-input'></td></tr></table>");
                        !0 === this.hidden && a(s).css("display", "none");
                        this.search = !1 === this.search ? !1 : !0;
                        void 0 === this.stype && (this.stype = "text");
                        g = a.extend({}, this.searchoptions || {});
                        if (this.search) {
                            if (b.searchOperators) {
                                l = g.sopt ? g.sopt[0] : "select" === e.stype ? "eq" : b.defaultSearch;
                                for (var q = 0; q < b.odata.length; q++)if (b.odata[q].oper === l) {
                                    j = b.operands[l] || "";
                                    break
                                }
                                l = "<a href='#' title='" + (null != g.searchtitle ? g.searchtitle : b.operandTitle) + "' style='padding-right: 0.5em;' soper='" + l + "' class='soptclass' colindex='" + k + "'>" + j + "</a>"
                            }
                            a("td:eq(0)",
                                m).append(l);
                            switch (this.stype) {
                                case "select":
                                    if (l = this.surl || g.dataUrl)a.ajax(a.extend({url: l, dataType: "html", success: function (k) {
                                        if (g.buildSelect !== void 0) {
                                            if (k = g.buildSelect(k)) {
                                                a("td:eq(1)", m).append(k);
                                                a(i).append(m)
                                            }
                                        } else {
                                            a("td:eq(1)", m).append(k);
                                        ...
                                        g.defaultValue !== void 0 && a("select", i).val(g.defaultValue);
                                        a("select", i).attr({name: e.index || e.name, id: "gs_" + e.name});
                                        g.attr && a("select", i).attr(g.attr);
                                        a("select", i).css({width: "100%"});
                                        a.jgrid.bindEv.call(c, a("select", i)[0], g);
                                        b.autosearch ===
                                        true && a("select", i).change(function () {
                                            d();
                                            return false
                                        });
                                        k = null
                                        ...
                                        if (n) {
                                            ...
                                            k.style.width = "100%";
                                            a(k).attr({name: e.index || e.name, id: "gs_" + e.name});
                                            var r;
                                            if ("string" === typeof n) {
                                                l = n.split(o);
                                                for (r = 0; r < l.length; r++)n = l[r].split(p), o = document.createElement("option"), o.value = n[0], o.innerHTML = n[1], k.appendChild(o)
                                            } else if ("object" === typeof n)for (r in n)n.hasOwnProperty(r) && (o = document.createElement("option"), o.value = r, o.innerHTML = n[r], k.appendChild(o));
                                            void 0 !== g.defaultValue && a(k).val(g.defaultValue);
                                            g.attr &&
                                            a(k).attr(g.attr);
                                            a.jgrid.bindEv.call(c, k, g);
                                            a("td:eq(1)", m).append(k);
                                            a(i).append(m);
                                    ...
                                    break;
                                case "text":
                                    p = void 0 !== g.defaultValue ? g.defaultValue : "";
                                    a("td:eq(1)", m).append("<input type='text' style='width:100%;padding:0px;' name='" + (e.index || e.name) + "' id='gs_" + e.name + "' value='" + p + "'/>");
                                    a(i).append(m);
                                    g.attr && a("input", i).attr(g.attr);
                                    a.jgrid.bindEv.call(c, a("input", i)[0], g);
                                    ...
                                    break;
                                case "custom":
                                    a("td:eq(1)", m).append("<span style='width:95%;padding:0px;' name='" + (e.index || e.name) + "' id='gs_" + e.name + "'/>");
                                    a(i).append(m);
                                    try {
                                        if (a.isFunction(g.custom_element)) {
                                            var u = g.custom_element.call(c, void 0 !== g.defaultValue ? g.defaultValue :
                                                "", g);
                    ...
                    b.searchOperators && a(".soptclass").click(function () {
                        var b = a(this).offset();
                        j(this, b.left, b.top)
                    });
                    this.ftoolbar = !0;
                    ...
                    this.clearToolbar = function (d) {
                        var e = {}, g = 0, l, d = "boolean" !== typeof d ? !0 : d;
                        a.each(c.p.colModel, function () {
                            ...
                            switch (this.stype) {
                                ...
                                case "text":
                                    ...
                                    break;
                                case "custom":
                                    a.isFunction(this.searchoptions.custom_value) && 0 < d.length && "SPAN" === d[0].nodeName.toUpperCase() && this.searchoptions.custom_value.call(c, d.children(".customelement:first"),
                                        "set", b)
                            }
                        });
                        var h = 0 < g ? !0 : !1;
                        if (!0 === b.stringResult || "local" === c.p.datatype) {
                            var f = '{"groupOp":"' + b.groupOp + '","rules":[', i = 0;
                            a.each(e, function (a, b) {
                                0 < i && (f += ",");
                                f += '{"field":"' + a + '",';
                                f += '"op":"eq",';
                                f += '"data":"' + (b + "").replace(/\\/g, "\\\\").replace(/\"/g, '\\"') + '"}';
                                i++
                            });
                            f += "]}";
                            a.extend(c.p.postData, {filters: f});
                            a.each(["searchField", "searchString", "searchOper"], function (a, b) {
                                c.p.postData.hasOwnProperty(b) && delete c.p.postData[b]
                            })
                        } else a.extend(c.p.postData, e);
                        var m;
                        c.p.searchurl && (m = c.p.url,
                            a(c).jqGrid("setGridParam", {url: c.p.searchurl}));
                        var j = "stop" === a(c).triggerHandler("jqGridToolbarBeforeClear") ? !0 : !1;
                        !j && a.isFunction(b.beforeClear) && (j = b.beforeClear.call(c));
                        j || d && a(c).jqGrid("setGridParam", {search: h}).trigger("reloadGrid", [
                            {page: 1}
                        ]);
                        m && a(c).jqGrid("setGridParam", {url: m});
                        a(c).triggerHandler("jqGridToolbarAfterClear");
                        a.isFunction(b.afterClear) && b.afterClear()
                    };
                    this.toggleToolbar = function () {
                        var b = a("tr.ui-search-toolbar", c.grid.hDiv), d = !0 === c.p.frozenColumns ? a("tr.ui-search-toolbar",
                            c.grid.fhDiv) : !1;
            ...
            return this.each(function () {
                var c, d, j, h, f, k;
                d = this.grid;
                var e = a("table.ui-jqgrid-htable thead", d.hDiv), g = this.p.colModel;
                if (d) {
                    ...
                    for (j = h.length; d < j; d++) {
                        f = g[d].hidden ? "none" : "";
                        f = a(h[d].el).width(h[d].width).css("display", f);
                        try {
                        ...
                        c.append(f);
                        k = f.children("span.ui-jqgrid-resize");
                        0 < k.length && (k[0].style.height = "");
                        f.children("div")[0].style.top = ""
                    }
                    a(e).children("tr.ui-jqgrid-labels").remove();
                    a(e).prepend(c);
            ...
            b =
                a.extend({useColSpanStyle: !1, groupHeaders: []}, b || {});
            return this.each(function () {
                this.p.groupHeader = b;
                var c, d, j = 0, h, f, k, e, g, l = this.p.colModel, v = l.length, s = this.grid.headers, i = a("table.ui-jqgrid-htable", this.grid.hDiv), m = i.children("thead").children("tr.ui-jqgrid-labels:last").addClass("jqg-second-row-header");
                h = i.children("thead");
                var q = i.find(".jqg-first-row-header");
                void 0 === q[0] ? q = a("<tr>", {role: "row", "aria-hidden": "true"}).addClass("jqg-first-row-header").css("height", "auto") : q.empty();
                var n,
                    p = function (a, b) {
                        var c = b.length, d;
                ...
                a(this).prepend(h);
                h = a("<tr>", {role: "rowheader"}).addClass("ui-jqgrid-labels jqg-third-row-header");
                for (c = 0; c < v; c++)if (k = s[c].el, e = a(k), d = l[c], f = {height: "0px", width: s[c].width + "px", display: d.hidden ? "none" : ""}, a("<th>", {role: "gridcell"}).css(f).addClass("ui-first-th-" + this.p.direction).appendTo(q), k.style.width = "", f = p(d.name, b.groupHeaders), 0 <= f) {
                    f = b.groupHeaders[f];
                    j = f.numberOfColumns;
                    g = f.titleText;
                    for (f =
                             d = 0; f < j && c + f < v; f++)l[c + f].hidden || d++;
                    f = a("<th>").attr({role: "columnheader"}).addClass("ui-state-default ui-th-column-header ui-th-" + this.p.direction).css({height: "22px", "border-top": "0px none"}).html(g);
                    0 < d && f.attr("colspan", "" + d);
                    this.p.headertitles && f.attr("title", f.text());
                    0 === d && f.hide();
                    e.before(f);
                    h.append(k);
                    j -= 1
                } else 0 === j ? b.useColSpanStyle ? e.attr("rowspan", "2") : (a("<th>", {role: "columnheader"}).addClass("ui-state-default ui-th-column-header ui-th-" + this.p.direction).css({display: d.hidden ?
                    "none" : "", "border-top": "0px none"}).insertBefore(e), h.append(k)) : (h.append(k), j--);
                ...
                n = l.find("tr.jqg-first-row-header");
            ...
            return this.each(function () {
                if (this.grid) {
                    var b = this, c = b.p.colModel, d = 0, j = c.length, h = -1, f = !1;
                    if (!(!0 === b.p.subGrid || !0 === b.p.treeGrid || !0 === b.p.cellEdit || b.p.sortable || b.p.scroll || b.p.grouping)) {
                        b.p.rownumbers && d++;
                        for (b.p.multiselect && d++; d < j;) {
                            if (!0 === c[d].frozen)f = !0, h = d; else break;
                            d++
                        }
                        if (0 <= h && f) {
                            c = b.p.caption ? a(b.grid.cDiv).outerHeight() :
                                0;
                            ...
                            a(b).bind("jqGridOnSortCol.setFrozenColumns", function (c, d, e) {
                                ...
                                d = a("tr.ui-jqgrid-labels:last th:eq(" +
                                    e + ")", b.grid.fhDiv);
...
(function (a) {
    ...
    a.jgrid.extend({searchGrid: function (b) {
        ...
        return this.each(function () {
                    ...
                    o && (a('td[role="gridcell"]', o).each(function (j) {
                        ...
                        if ("cb" !== l && "subgrid" !== l && "rn" !== l && !0 === m[j].editable) {
                            ...
                            switch (m[j].edittype) {
                                ...
                                case "checkbox":
                                    g = "" + g;
                                    if (m[j].editoptions && m[j].editoptions.value)if (m[j].editoptions.value.split(":")[0] == g)a("#" + l, "#" + f)[d.p.useProp ? "prop" : "attr"]({checked: !0, defaultChecked: !0}); else a("#" + l, "#" + f)[d.p.useProp ?
                                        "prop" : "attr"]({checked: !1, defaultChecked: !1}); else g = g.toLowerCase(), 0 > g.search(/(false|f|0|no|n|off|undefined)/i) && "" !== g ? (a("#" + l, "#" + f)[d.p.useProp ? "prop" : "attr"]("checked", !0), a("#" + l, "#" + f)[d.p.useProp ? "prop" : "attr"]("defaultChecked", !0)) : (a("#" + l, "#" + f)[d.p.useProp ? "prop" : "attr"]("checked", !1), a("#" + l, "#" + f)[d.p.useProp ? "prop" : "attr"]("defaultChecked", !1));
                                    break;
                                case "custom":
                                    try {
                                        if (m[j].editoptions && a.isFunction(m[j].editoptions.custom_value))m[j].editoptions.custom_value.call(d, a("#" + l, "#" +
                                            f), "set", g); else throw"e1";
                                    } catch (p) {
            ...
            function s() {
                var e, l = [!0, "", ""], g = {}, h = d.p.prmNames, i, m, r, o, n, z = a(d).triggerHandler("jqGridAddEditBeforeCheckValues",
                    [a("#" + f), v]);
                ...
                u();
                l[0] && (g = a(d).triggerHandler("jqGridAddEditClickSubmit", [b[d.p.id], j, v]), void 0 === g && a.isFunction(b[d.p.id].onclickSubmit) && (g = b[d.p.id].onclickSubmit.call(d, b[d.p.id], j, v) || {}), l = a(d).triggerHandler("jqGridAddEditBeforeSubmit", [j, a("#" + f),
                    v]), void 0 === l && (l = [!0, "", ""]), l[0] && a.isFunction(b[d.p.id].beforeSubmit) && (l = b[d.p.id].beforeSubmit.call(d, j, a("#" + f), v)));
                if (l[0] && !b[d.p.id].processing) {
                    ...
                    if (!0 === d.p.treeGrid)for (n in j[m] == h.addoper && (o = a(d).jqGrid("getGridParam",
                        "selrow"), j["adjacency" == d.p.treeGridModel ? d.p.treeReader.parent_id_field : "parent_id"] = o), d.p.treeReader)d.p.treeReader.hasOwnProperty(n) && (g = d.p.treeReader[n], j.hasOwnProperty(g) && !(j[m] == h.addoper && "parent_id_field" === n) && delete j[g]);
                    ...
                    n = a.extend({url: b[d.p.id].url || a(d).jqGrid("getGridParam", "editurl"), type: b[d.p.id].mtype, data: a.isFunction(b[d.p.id].serializeEditData) ? b[d.p.id].serializeEditData.call(d, j) : j, complete: function (g, r) {
                        ...
                        if (l[0] === false) {
                            ...
                            if (j[m] === h.addoper) {
                                ...
                                j[i] = l[2];
                                if (b[d.p.id].reloadAfterSubmit)a(d).trigger("reloadGrid"); else {
                                    d.p.treeGrid === true ? a(d).jqGrid("addChildNode", l[2], o, j) : a(d).jqGrid("addRowData", l[2], j, c.addedrow);
        ...
        return this.each(function () {
            ...
            function t(b, c) {
                ...
                if (h = a(c).jqGrid("getInd", b, !0))a("td", h).each(function (b) {
                    ...
                    "cb" !== d && "subgrid" !== d && "rn" !== d && (f = d == c.p.ExpandColumn && !0 === c.p.treeGrid ? a(this).text() : a(this).html(), a.extend({}, c.p.colModel[b].editoptions || {}), d = a.jgrid.jqID("v_" + d), a("#" + d + " span", "#" + n).html(f), e && a("#" + d, "#" + n).parents("tr:first").hide(), g++)
                }), 0 < g && a("#id_g", "#" + n).val(b)
            }

            function u(b, c) {
                var d = c[1].length - 1;
                0 === b ? a("#pData", "#" + n + "_2").addClass("ui-state-disabled") : void 0 !== c[1][b - 1] && a("#" + a.jgrid.jqID(c[1][b - 1])).hasClass("ui-state-disabled") ? a("#pData",
                        n + "_2").addClass("ui-state-disabled") : a("#pData", "#" + n + "_2").removeClass("ui-state-disabled");
            ...
            var m = this;
            if (m.grid && r) {
                var h = m.p.id, g = "ViewGrid_" + a.jgrid.jqID(h),
                    n = "ViewTbl_" + a.jgrid.jqID(h), x = "ViewGrid_" + h, d = "ViewTbl_" + h, q = {themodal: "viewmod" + h, modalhead: "viewhd" + h, modalcontent: "viewcnt" + h, scrollelm: g}, f = a.isFunction(b[m.p.id].beforeInitData) ? b[m.p.id].beforeInitData : !1, o = !0, k = 1, p = 0;
                ...
                if (void 0 !== a("#" + a.jgrid.jqID(q.themodal))[0]) {
                    ...
                    var y = isNaN(c.dataheight) ? c.dataheight : c.dataheight + "px", A = isNaN(c.datawidth) ? c.datawidth : c.datawidth + "px", x = a("<form name='FormPost' id='" + x + "' class='FormGrid' style='width:" + A + ";overflow:auto;position:relative;height:" + y + ";'></form>"), w = a("<table id='" +
                        d + "' class='EditTable' cellspacing='1' cellpadding='2' border='0' style='table-layout:fixed'><tbody></tbody></table>");
                    f && (o = f.call(m, a("#" + g)), void 0 === o && (o = !0));
                    if (!1 === o)return;
                    ...
                    x = a("<div></div>").append(x).append("<table border='0' class='EditTable' id='" +
                        n + "_2'><tbody><tr id='Act_Buttons'><td class='navButton' width='" + c.labelswidth + "'>" + (d ? o + f : f + o) + "</td><td class='EditButton'>" + y + "</td></tr></tbody></table>");
                    ...
                    a("#" + q.themodal).keydown(function (d) {
                        if (d.which === 27) {
                            ...
                            a.jgrid.hideModal("#" + a.jgrid.jqID(q.themodal), {gb: c.gbox, jqm: c.jqModal, onClose: c.onClose});
                            return false
                        }
                        if (c.navkeys[0] === true) {
                    ...
                    c.closeicon = a.extend([!0, "left", "ui-icon-close"], c.closeicon);
                    !0 === c.closeicon[0] && a("#cData", "#" + n + "_2").addClass("right" == c.closeicon[1] ? "fm-button-icon-right" : "fm-button-icon-left").append("<span class='ui-icon " +
                        c.closeicon[2] + "'></span>");
                    a.isFunction(c.beforeShowForm) && c.beforeShowForm.call(m, a("#" + g));
                    a.jgrid.viewModal("#" + a.jgrid.jqID(q.themodal), {gbox: "#gbox_" + a.jgrid.jqID(h), jqm: c.jqModal, overlay: c.overlay, modal: c.modal});
                    ...
                    a("#cData", "#" + n + "_2").click(function () {
                        a.jgrid.hideModal("#" + a.jgrid.jqID(q.themodal), {gb: "#gbox_" + a.jgrid.jqID(h), jqm: c.jqModal,
                            onClose: c.onClose});
                        return false
                    });
                    ...
                    a("#pData", "#" + n + "_2").click(function () {
                        ...
                        var b = s();
                        if (b[0] != -1 && b[1][b[0] - 1]) {
                            a.isFunction(c.onclickPgButtons) && c.onclickPgButtons.call(m, "prev", a("#" + g), b[1][b[0]]);
                            t(b[1][b[0] - 1], m);
                            a(m).jqGrid("setSelection", b[1][b[0] - 1]);
        ...
        c = a.extend(!0, {top: 0, left: 0, width: 240, height: "auto", dataheight: "auto", modal: !1, overlay: 30, drag: !0, resize: !0, url: "", mtype: "POST", reloadAfterSubmit: !0,
            beforeShowForm: null, beforeInitData: null, afterShowForm: null, beforeSubmit: null, onclickSubmit: null, afterSubmit: null, jqModal: !0, closeOnEscape: !1, delData: {}, delicon: [], cancelicon: [], onClose: null, ajaxDelOptions: {}, processing: !1, serializeDelData: null, useDataProxy: !1}, a.jgrid.del, c || {});
        b[a(this)[0].p.id] = c;
        return this.each(function () {
            var e = this;
            if (e.grid && r) {
                var i = a.isFunction(b[e.p.id].beforeShowForm), t = a.isFunction(b[e.p.id].afterShowForm), u = a.isFunction(b[e.p.id].beforeInitData) ? b[e.p.id].beforeInitData :
                    !1, s = e.p.id, m = {}, h = !0, g = "DelTbl_" + a.jgrid.jqID(s), n, x, d, q, f = "DelTbl_" + s, o = {themodal: "delmod" + s, modalhead: "delhd" + s, modalcontent: "delcnt" + s, scrollelm: g};
                ...
                if (void 0 !== a("#" + a.jgrid.jqID(o.themodal))[0]) {
                    ...
                    a.jgrid.viewModal("#" +
                        a.jgrid.jqID(o.themodal), {gbox: "#gbox_" + a.jgrid.jqID(s), jqm: b[e.p.id].jqModal, jqM: !1, overlay: b[e.p.id].overlay, modal: b[e.p.id].modal})
                } else {
                    ...
                    !0 === c.delicon[0] && a("#dData", "#" + g + "_2").addClass("right" == c.delicon[1] ? "fm-button-icon-right" : "fm-button-icon-left").append("<span class='ui-icon " + c.delicon[2] + "'></span>");
                    ...
                    a("#dData", "#" + g + "_2").click(function () {
                        ...
                        if (f[0] && !b[e.p.id].processing) {
                            ...
                            h = a.extend({url: b[e.p.id].url || a(e).jqGrid("getGridParam", "editurl"), type: b[e.p.id].mtype, data: a.isFunction(b[e.p.id].serializeDelData) ?
                                b[e.p.id].serializeDelData.call(e, n) : n, complete: function (d, h) {
                                var k;
            ...
            if (!this.nav) {
                ...
                if (h.grid && "string" === typeof b) {
                    ...
                    for (x = 0; x < n; x++) {
                        ...
                        0 === x ? (o = b, k = h.p.id, o == h.p.toppager && (k += "_top", n = 1)) : (o = h.p.toppager, k = h.p.id +
                            "_top");
                        ...
                        c.edit && (g = a("<td class='ui-pg-button ui-corner-all'></td>"),
                            e = e || {}, a(g).append("<div class='ui-pg-div'><span class='ui-icon " + c.editicon + "'></span>" + c.edittext + "</div>"), a("tr", f).append(g), a(g, f).attr({title: c.edittitle || "", id: e.id || "edit_" + k}).click(function () {
                        ...
                        c.view && (g = a("<td class='ui-pg-button ui-corner-all'></td>"),
                            s = s || {}, a(g).append("<div class='ui-pg-div'><span class='ui-icon " + c.viewicon + "'></span>" + c.viewtext + "</div>"), a("tr", f).append(g), a(g, f).attr({title: c.viewtitle || "", id: s.id || "view_" + k}).click(function () {
                            if (!a(this).hasClass("ui-state-disabled")) {
                                var b = h.p.selrow;
                        ...
                        c.del && (g = a("<td class='ui-pg-button ui-corner-all'></td>"),
                            t = t || {}, a(g).append("<div class='ui-pg-div'><span class='ui-icon " + c.delicon + "'></span>" + c.deltext + "</div>"), a("tr", f).append(g), a(g, f).attr({title: c.deltitle || "", id: t.id || "del_" + k}).click(function () {
                            if (!a(this).hasClass("ui-state-disabled")) {
                                var b;
                                if (h.p.multiselect) {
                                    b = h.p.selarrrow;
                                ...
                                if (b)a.isFunction(c.delfunc) ? c.delfunc.call(h, b) : a(h).jqGrid("delGridRow", b, t); else {
                                    a.jgrid.viewModal("#" + m.themodal, {gbox: "#gbox_" + a.jgrid.jqID(h.p.id), jqm: true});
                                    a("#jqg_alrt").focus()
                                }
                            }
                        ...
                        c.search && (g = a("<td class='ui-pg-button ui-corner-all'></td>"), u = u || {}, a(g).append("<div class='ui-pg-div'><span class='ui-icon " + c.searchicon + "'></span>" + c.searchtext + "</div>"), a("tr", f).append(g), a(g, f).attr({title: c.searchtitle || "", id: u.id || "search_" + k}).click(function () {
                            a(this).hasClass("ui-state-disabled") || (a.isFunction(c.searchfunc) ?
                                c.searchfunc.call(h, u) : a(h).jqGrid("searchGrid", u));
                            return false
                        }).hover(d, q), u.showOnLoad && !0 === u.showOnLoad && a(g, f).click(), g = null);
                        c.refresh && (g = a("<td class='ui-pg-button ui-corner-all'></td>"), a(g).append("<div class='ui-pg-div'><span class='ui-icon " + c.refreshicon + "'></span>" + c.refreshtext + "</div>"), a("tr", f).append(g), a(g, f).attr({title: c.refreshtitle || "", id: "refresh_" + k}).click(function () {
                            if (!a(this).hasClass("ui-state-disabled")) {
                                ...
                                a.isFunction(c.afterRefresh) && c.afterRefresh.call(h)
                            }
                            return false
                        }).hover(d, q), g = null);
        ...
        return this.each(function () {
            if (this.grid) {
                ...
                if (e && !(c.id && void 0 !== a("#" + a.jgrid.jqID(c.id), e)[0])) {
                    var t = a("<td></td>");
                    "NONE" == c.buttonicon.toString().toUpperCase() ? a(t).addClass("ui-pg-button ui-corner-all").append("<div class='ui-pg-div'>" + c.caption + "</div>") : a(t).addClass("ui-pg-button ui-corner-all").append("<div class='ui-pg-div'><span class='ui-icon " + c.buttonicon + "'></span>" + c.caption + "</div>");
                    c.id && a(t).attr("id", c.id);
                    "first" == c.position ? 0 === e.rows[0].cells.length ? a("tr", e).append(t) : a("tr td:eq(0)",
                        e).before(t) : a("tr", e).append(t);
        ...
        return this.each(function () {
            ...
            if (e.grid) {
                ...
                if (t)for (i in t)t.hasOwnProperty(i) && (a("[name=" + a.jgrid.jqID(i) +
                    "]", c).is("input:radio") || a("[name=" + a.jgrid.jqID(i) + "]", c).is("input:checkbox") ? a("[name=" + a.jgrid.jqID(i) + "]", c).each(function () {
        ...
        return this.each(function () {
            if (this.grid) {
                ...
                "add" == e ? a(this).jqGrid("addRowData",
                    b, u, i) : "set" == e && a(this).jqGrid("setRowData", b, u)
            }
        })
    }})
})(jQuery);
...
(function (a) {
    ...
    a.jgrid.extend({editRow: function (c, b, e, o, l, g, n, h, f) {
        ...
        if ("1" === h) {
            ...
            if (i) {
                i[h.oper] = h.editoper;
                if (void 0 === i[p])i[p] = c; else if (q.id !== d.p.idPrefix + i[p] && (h = a.jgrid.stripPref(d.p.idPrefix, c), void 0 !== d.p._index[h] && (d.p._index[i[p]] =
                    d.p._index[h], delete d.p._index[h]), c = d.p.idPrefix + i[p], a(q).attr("id", c), d.p.selrow === u && (d.p.selrow = c), a.isArray(d.p.selarrrow) && (h = a.inArray(u, d.p.selarrrow), 0 <= h && (d.p.selarrrow[h] = c)), d.p.multiselect))h = "jqg_" + d.p.id + "_" + c, a("input.cbox", q).attr("id", h).attr("name", h);
        ...
        b = a.extend({edit: !0, editicon: "ui-icon-pencil", add: !0, addicon: "ui-icon-plus", save: !0, saveicon: "ui-icon-disk", cancel: !0, cancelicon: "ui-icon-cancel", addParams: {addRowParams: {extraparam: {}}}, editParams: {}, restoreAfterSelect: !0},
            a.jgrid.nav, b || {});
        return this.each(function () {
            if (this.grid) {
...
(function (d) {
    d.jgrid.extend({setTreeNode: function (b, c) {
        return this.each(function () {
            var a = this;
            if (a.grid && a.p.treeGrid)for (var h = a.p.expColInd, e = a.p.treeReader.expanded_field, i = a.p.treeReader.leaf_field, g = a.p.treeReader.level_field, f = a.p.treeReader.icon_field, l = a.p.treeReader.loaded, k, m, n, j; b < c;)j = a.p.data[a.p._index[a.rows[b].id]], "nested" == a.p.treeGridModel && !j[i] && (k = parseInt(j[a.p.treeReader.left_field], 10), m = parseInt(j[a.p.treeReader.right_field], 10), j[i] = m === k + 1 ? "true" : "false", a.rows[b].cells[a.p._treeleafpos].innerHTML =
                ...
                b = d(b.target || b.srcElement, a.rows).closest("tr.jqgrow")[0].id;
                b = a.p._index[b];
                ...
                var b = d(b.target || b.srcElement, a.rows).closest("tr.jqgrow")[0].id, c = a.p._index[b];
        ...
        return this.each(function () {
            ...
            if (b.p.treeGrid) {
                ...
                b.p.expColInd = 0;
                b.p.treeIcons =
                    d.extend({plus: "ui-icon-triangle-1-" + ("rtl" == b.p.direction ? "w" : "e"), minus: "ui-icon-triangle-1-s", leaf: "ui-icon-radio-off"}, b.p.treeIcons || {});
                "nested" == b.p.treeGridModel ? b.p.treeReader = d.extend({level_field: "level", left_field: "lft", right_field: "rgt", leaf_field: "isLeaf", expanded_field: "expanded", loaded: "loaded", icon_field: "icon"}, b.p.treeReader) : "adjacency" == b.p.treeGridModel && (b.p.treeReader = d.extend({level_field: "level", parent_id_field: "parent", leaf_field: "isLeaf", expanded_field: "expanded", loaded: "loaded",
                    icon_field: "icon"}, b.p.treeReader));
        ...
        expandRow: function (b) {
                ...
                if (a.grid && a.p.treeGrid)switch (a.p.treeGridModel) {
                    case "nested":
                        var h = a.p.treeReader.left_field, e = a.p.treeReader.right_field,
                            i = a.p.treeReader.level_field, g = parseInt(b[h], 10), f = parseInt(b[e], 10), l = parseInt(b[i], 10);
            ...
            this.each(function () {
                ...
                if (a.grid && a.p.treeGrid)switch (a.p.treeGridModel) {
                    case "nested":
                        var h =
                            a.p.treeReader.left_field, e = a.p.treeReader.right_field, i = a.p.treeReader.level_field, g = parseInt(b[h], 10), f = parseInt(b[e], 10), l = parseInt(b[i], 10);
                        d(this.p.data).each(function () {
                    ...
                    case "adjacency":
                        if (b) {
                            ...
                            d(this.p.data).each(function (b) {
                                h = c.length;
                                for (b = 0; b < h; b++)if (d.jgrid.stripPref(a.p.idPrefix,
                                    c[b][n]) === this[m]) {
                                    c.push(this);
                                    break
                                }
            ...
            return this.each(function () {
                if (this.grid && this.p.treeGrid) {
                    ...
                    if (!b[c]) {
                        var f = d.jgrid.getAccessor(b,
                            this.p.localReader.id), l = d("#" + d.jgrid.jqID(f), this.grid.bDiv)[0], k = this.p._index[f];
                        d(this).jqGrid("isNodeLoaded", this.p.data[k]) ? (b[c] = !0, d("div.treeclick", l).removeClass(this.p.treeIcons.plus + " tree-plus").addClass(this.p.treeIcons.minus + " tree-minus")) : this.grid.hDiv.loading || (b[c] = !0, d("div.treeclick", l).removeClass(this.p.treeIcons.plus + " tree-plus").addClass(this.p.treeIcons.minus + " tree-minus"), this.p.treeANode = l.rowIndex, this.p.datatype = this.p.treedatatype, "nested" == this.p.treeGridModel ?
                            d(this).jqGrid("setGridParam", {postData: {nodeid: f, n_left: b[i], n_right: b[g], n_level: b[e]}}) : d(this).jqGrid("setGridParam", {postData: {nodeid: f, parentid: b[a], n_level: b[e]}}), d(this).trigger("reloadGrid"), b[h] = !0, "nested" == this.p.treeGridModel ? d(this).jqGrid("setGridParam", {postData: {nodeid: "", n_left: "", n_right: "", n_level: ""}}) : d(this).jqGrid("setGridParam", {postData: {nodeid: "", parentid: "", n_level: ""}}))
                    }
                }
            })
            ...
            return this.each(function () {
                if (this.grid && this.p.treeGrid) {
                    ...
                    b[c] && (b[c] = !1, c = d.jgrid.getAccessor(b, this.p.localReader.id), c = d("#" + d.jgrid.jqID(c), this.grid.bDiv)[0], d("div.treeclick", c).removeClass(this.p.treeIcons.minus + " tree-minus").addClass(this.p.treeIcons.plus + " tree-plus"))
                }
            })
        ...
        setTreeRow: function (b, c) {
            ...
            return this.each(function () {
                var c = this.p.localReader.id, a, h = this.p.treeReader.left_field, e = this.p.treeReader.right_field, i, g, f;
                if (this.grid && this.p.treeGrid && (a = this.p._index[b], void 0 !== a)) {
                    ...
                    if (0 < l.length)for (a = 0; a < l.length; a++)d(this).jqGrid("delRowData",
                        l[a][c]);
